...
<html lang="en">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        ...
        <main>
            <div>
                <h3 style="border-top: 1em solid #AA8B56; color: #557153; text-align: center; padding: 120px; font-weight: 600;">MEDICO merupakan aplikasi di segmen kesehatan yang memberikan manfaat dalam meningkatkan serta menjaga mental health bagi mahasiswa di Indonesia. Aplikasi ini dibuat karena melihat banyaknya permasalahan mengenai mental health terutama dari kalangan mahasiswa di Indonesia.</h3>
            </div>
            <!-- ======= Our Team Section ======= -->
